...
export default function Category() {
    const { search, categories } = usePage<Props>().props;
    ...
    const handleOpen = (edit = false, category: Category | null = null) => {
        clearErrors();
        setEdit(edit);
...
Category.layout = (page: ReactPortal) => <AppLayout children={page} />;
